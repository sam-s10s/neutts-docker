...
class NeuTTS:
    ...
    def __init__(
        ...
        sample_rate: Literal[16_000, 24_000] = 24_000,
        language: str = "en-us",
    ):
    ...
    def infer(
        ...
        watermarked_wav = (
            ...
            else self.watermarker.apply_watermark(wav, sample_rate=self.sample_rate)
        )
        ...
        for item in self.backbone(
            ...
            if (
                ...
                recon = (
                    recon
                    if self.watermarker is None
                    else self.watermarker.apply_watermark(
                        recon, sample_rate=self.sample_rate
                    )
                )
